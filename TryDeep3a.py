# -*- coding: utf-8 -*-
"""
Created on Tue May 23 11:04:06 2023
...
print(unpickle("C:/Users/Lenovo/Desktop/data/data/cifar-10-batches-py/data_batch_1").keys())
print(unpickle("C:/Users/Lenovo/Desktop/data/data/cifar-10-batches-py/test_batch").keys())
...
def train_r(buffered_size=1024):
    def reader():
        ...
        ys = []
        for i in range(1, 6):
            train_dict = unpickle("C:/Users/Lenovo/Desktop/data/data/cifar-10-batches-py/data_batch_%d" % (i,))
...
def test_r(buffered_size=1024):
    def reader():
        test_dict = unpickle("C:/Users/Lenovo/Desktop/data/data/cifar-10-batches-py/test_batch")
        X = test_dict[b'data']
